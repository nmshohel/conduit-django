...
from .serializers import (
    LoginSerializer, RegistrationSerializer,SuperUserRegistrationSerializer,
    PbsUserSerializer,PbsUsersSerializer,RebUserSerializer,RebUsersSerializer,
)
...
class PbsUserRetrieveUpdateAPIView(RetrieveUpdateAPIView):
    ...
    def retrieve(self, request,username, *args, **kwargs):
        ...
        try:
            user = User.objects.get(username=username,is_management=False)
    ...
    def update(self, request, *args, **kwargs):
        ...
        'pbs':{
            ...
            'management_id':user_data.get('management_id', request.user.pbs.management_id),
...
class RebUserRetrieveUpdateAPIView(RetrieveUpdateAPIView):
    permission_classes = (IsAuthenticated,)
    renderer_classes = (UserJSONRenderer,)
    serializer_class = RebUserSerializer

    def retrieve(self, request,username, *args, **kwargs):
        
        try:
            user = User.objects.get(username=username,is_management=True)
    ...
    def update(self, request, *args, **kwargs):
        ...
        'management':{
            'breb_office_name_en':user_data.get('breb_office_name_en',request.user.management.breb_office_name_en),
            'breb_office_name_bn':user_data.get('breb_office_name_bn',request.user.management.breb_office_name_bn),
        }
    }
...
class SuperUserRegistrationAPIView(APIView):
    permission_classes = (AllowAny,)
    #renderer_classes = (UserJSONRenderer,)
