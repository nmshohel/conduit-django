                                               ...
                                               <table class="table table-hover table-bordered" id="example">
                                                <thead>
                                                  <tr>
                                                    <th>ID</th>
                                                    <th>Pbs Code</th>
                                                    <th>install_meter_nos</th>
                                                    <th>capacity_of_install_meter</th>
                                                  </tr>
                                                </thead>
                                                <tbody>
                                                  <tr v-for="item in netmeters" :key="item.id">
                                                    <td>{{item.id}}</td>
                                                    <td>{{item.pbs_code}}</td>
                                                    <td>{{item.install_meter_nos}}</td>
                                                    <td>{{item.capacity_of_install_meter}}</td>
                                                  </tr>
...
export default {
  ...
  mounted(){
    ...
    axios
    .get("http://127.0.0.1:8000/api/v1/net_meter_info/")
    .then((res)=>
    {
