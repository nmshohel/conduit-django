...
export default {
  ...
  methods: {
    ...
    retrieveTutorials() {
      ...
      TutorialDataService.getAllm(params)
        .then((response) => {
    ...
    getDisplayTutorial(netmeterinfo) {
      return {
        id: netmeterinfo.id,
        title: netmeterinfo.pbs_code.substr(0, 20) + "...",
        description: netmeterinfo.capacity_of_install_meter.substr(0, 20) + "...",
        status: netmeterinfo.capacity_of_install_meter.substr(0, 20) + "...",
      };
    },
  },
  mounted() {
